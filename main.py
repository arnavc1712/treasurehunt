...
def get_page(page):
	...
	if page in cache:
		...
		try:
			return BeautifulSoup(urllib2.urlopen(page).read()),page
		except:
			return BeautifulSoup(""),""
...
def get_all_links(page,url):     #GETTING LINKS PRESENT IN EACH CRAWLED PAGE
	...
	for link in page.find_all('a'):
	 	...
	 	if link_url == None or "javascript" in link_url or "mailto" in link_url or "tel" in link_url or link_url=="": 
			pass
